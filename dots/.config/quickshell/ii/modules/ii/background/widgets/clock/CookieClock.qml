...
Item {
    ...
    property color colBackground: Appearance.colors.colPrimaryContainerSolid
    property color colOnBackground: ColorUtils.mix(Appearance.colors.colSecondary, Appearance.colors.colPrimaryContainerSolid, 0.15)
    property color colBackgroundInfo: ColorUtils.mix(Appearance.colors.colPrimary, Appearance.colors.colPrimaryContainerSolid, 0.55)
