...
Singleton {
    ...
    // Controlled by bar settings: 0 = weaker hover, 1 = stronger hover.
    property real hoverOpacityOffset: Config.ready ? Config.options.bar.tooltips.hoverOpacityOffset : 1
    property real hoverOpacity: Math.max(0, Math.min(1, root.hoverOpacityOffset))
    ...
    colors: QtObject {
        ...
        property color colLayer0Hover: ColorUtils.transparentize(ColorUtils.mix(colLayer0, colOnLayer0, 0.9, root.contentTransparency), 1 - root.hoverOpacity)
        ...
        property color colLayer1Hover: ColorUtils.transparentize(ColorUtils.mix(colLayer1, colOnLayer1, 0.92), 1 - root.hoverOpacity)
        ...
        property color colLayer2Hover: root.hoverOpacity > 0 ? ColorUtils.solveOverlayColor(colLayer1Base, ColorUtils.mix(colLayer2Base, colOnLayer2, 0.90), root.hoverOpacity) : colLayer2
        ...
        property color colLayer3Hover: root.hoverOpacity > 0 ? ColorUtils.solveOverlayColor(colLayer2Base, ColorUtils.mix(colLayer3Base, colOnLayer3, 0.90), root.hoverOpacity) : colLayer3
        ...
        property color colLayer4Hover: root.hoverOpacity > 0 ? ColorUtils.solveOverlayColor(colLayer3Base, ColorUtils.mix(colLayer4Base, colOnLayer4, 0.90), root.hoverOpacity) : colLayer4
