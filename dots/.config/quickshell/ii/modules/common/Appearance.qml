...
Singleton {
    ...
    property real rawContentTransparency: Config?.options.appearance.transparency.enable ? Config?.options.appearance.transparency.automatic ? autoContentTransparency : Config?.options.appearance.transparency.contentTransparency : 0
    property real contentTransparency: rawContentTransparency
    property real blurSupportAlpha: (Config?.options.appearance.transparency.enable && Config?.options.appearance.transparency.blur) ? 0.02 : 0

    function blurSupportColor(color) {
        const c = Qt.color(color)
        if (blurSupportAlpha <= 0 || c.a > 0)
            return c
        return Qt.rgba(c.r, c.g, c.b, blurSupportAlpha)
    }

    function solveSurfaceColor(baseColor, targetColor, overlayOpacity) {
        if (overlayOpacity <= 0)
            return blurSupportColor(ColorUtils.applyAlpha(targetColor, 0))
        return blurSupportColor(ColorUtils.solveOverlayColor(baseColor, targetColor, overlayOpacity))
    }

    function transparentSurfaceColor(color, percentage = 1) {
        return blurSupportColor(ColorUtils.transparentize(color, percentage))
    }
    ...
    colors: QtObject {
        ...
        property color colLayer0: root.transparentSurfaceColor(colLayer0Base, root.backgroundTransparency)
        property color colOnLayer0: m3colors.m3onBackground
        property color colLayer0Hover: root.transparentSurfaceColor(ColorUtils.mix(colLayer0, colOnLayer0, 0.9, root.contentTransparency))
        property color colLayer0Active: root.transparentSurfaceColor(ColorUtils.mix(colLayer0, colOnLayer0, 0.8, root.contentTransparency))
        property color colLayer0Border: ColorUtils.mix(root.m3colors.m3outlineVariant, colLayer0, 0.4)
        // Layer 1
        property color colLayer1Base: m3colors.m3surfaceContainerLow
        property color colLayer1: root.solveSurfaceColor(colLayer0Base, colLayer1Base, 1 - root.contentTransparency);
        property color colOnLayer1: m3colors.m3onSurfaceVariant;
        property color colOnLayer1Inactive: ColorUtils.mix(colOnLayer1, colLayer1, 0.45);
        property color colLayer1Hover: root.transparentSurfaceColor(ColorUtils.mix(colLayer1, colOnLayer1, 0.92), root.contentTransparency)
        property color colLayer1Active: root.transparentSurfaceColor(ColorUtils.mix(colLayer1, colOnLayer1, 0.85), root.contentTransparency);
        // Layer 2
        property color colLayer2Base: m3colors.m3surfaceContainer
        property color colLayer2: root.solveSurfaceColor(colLayer1Base, colLayer2Base, 1 - root.contentTransparency)
        property color colLayer2Hover: root.solveSurfaceColor(colLayer1Base, ColorUtils.mix(colLayer2Base, colOnLayer2, 0.90), 1 - root.contentTransparency)
        property color colLayer2Active: root.solveSurfaceColor(colLayer1Base, ColorUtils.mix(colLayer2Base, colOnLayer2, 0.80), 1 - root.contentTransparency);
        property color colLayer2Disabled: root.solveSurfaceColor(colLayer1Base, ColorUtils.mix(colLayer2Base, m3colors.m3background, 0.8), 1 - root.contentTransparency);
        property color colOnLayer2: m3colors.m3onSurface;
        property color colOnLayer2Disabled: ColorUtils.mix(colOnLayer2, m3colors.m3background, 0.4);
        // Layer 3
        property color colLayer3Base: m3colors.m3surfaceContainerHigh
        property color colLayer3: root.solveSurfaceColor(colLayer2Base, colLayer3Base, 1 - root.contentTransparency)
        property color colLayer3Hover: root.solveSurfaceColor(colLayer2Base, ColorUtils.mix(colLayer3Base, colOnLayer3, 0.90), 1 - root.contentTransparency)
        property color colLayer3Active: root.solveSurfaceColor(colLayer2Base, ColorUtils.mix(colLayer3Base, colOnLayer3, 0.80), 1 - root.contentTransparency);
        property color colOnLayer3: m3colors.m3onSurface;
        // Layer 4
        property color colLayer4Base: m3colors.m3surfaceContainerHighest
        property color colLayer4: root.solveSurfaceColor(colLayer3Base, colLayer4Base, 1 - root.contentTransparency)
        property color colLayer4Hover: root.solveSurfaceColor(colLayer3Base, ColorUtils.mix(colLayer4Base, colOnLayer4, 0.90), 1 - root.contentTransparency)
        property color colLayer4Active: root.solveSurfaceColor(colLayer3Base, ColorUtils.mix(colLayer4Base, colOnLayer4, 0.80), 1 - root.contentTransparency);
        ...
        property color colPrimaryContainerSolid: m3colors.m3primaryContainer
        property color colPrimaryContainerSolidHover: ColorUtils.mix(m3colors.m3primaryContainer, m3colors.m3onPrimaryContainer, 0.9)
        property color colPrimaryContainerSolidActive: ColorUtils.mix(m3colors.m3primaryContainer, m3colors.m3onPrimaryContainer, 0.8)
        property color colPrimaryContainer: root.transparentSurfaceColor(m3colors.m3primaryContainer, root.contentTransparency)
        property color colPrimaryContainerHover: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3primaryContainer, m3colors.m3onPrimaryContainer, 0.9), root.contentTransparency)
        property color colPrimaryContainerActive: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3primaryContainer, m3colors.m3onPrimaryContainer, 0.8), root.contentTransparency)
        ...
        property color colSecondaryContainerSolid: m3colors.m3secondaryContainer
        property color colSecondaryContainerSolidHover: ColorUtils.mix(m3colors.m3secondaryContainer, m3colors.m3onSecondaryContainer, 0.90)
        property color colSecondaryContainerSolidActive: ColorUtils.mix(m3colors.m3secondaryContainer, m3colors.m3onSecondaryContainer, 0.54)
        property color colSecondaryContainer: root.transparentSurfaceColor(m3colors.m3secondaryContainer, root.contentTransparency)
        property color colSecondaryContainerHover: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3secondaryContainer, m3colors.m3onSecondaryContainer, 0.90), root.contentTransparency)
        property color colSecondaryContainerActive: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3secondaryContainer, m3colors.m3onSecondaryContainer, 0.54), root.contentTransparency)
        ...
        property color colTertiaryContainerSolid: m3colors.m3tertiaryContainer
        property color colTertiaryContainerSolidHover: ColorUtils.mix(m3colors.m3tertiaryContainer, m3colors.m3onTertiaryContainer, 0.90)
        property color colTertiaryContainerSolidActive: ColorUtils.mix(m3colors.m3tertiaryContainer, colLayer1Active, 0.54)
        property color colTertiaryContainer: root.transparentSurfaceColor(m3colors.m3tertiaryContainer, root.contentTransparency)
        property color colTertiaryContainerHover: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3tertiaryContainer, m3colors.m3onTertiaryContainer, 0.90), root.contentTransparency)
        property color colTertiaryContainerActive: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3tertiaryContainer, colLayer1Active, 0.54), root.contentTransparency)
        property color colOnTertiary: m3colors.m3onTertiary
        property color colOnTertiaryContainer: m3colors.m3onTertiaryContainer
        // Surface
        property color colSurfaceContainerLowSolid: m3colors.m3surfaceContainerLow
        property color colSurfaceContainerSolid: m3colors.m3surfaceContainer
        property color colBackgroundSurfaceContainer: root.transparentSurfaceColor(m3colors.m3surfaceContainer, root.backgroundTransparency)
        property color colSurfaceContainerLow: root.solveSurfaceColor(m3colors.m3background, m3colors.m3surfaceContainerLow, 1 - root.contentTransparency)
        property color colSurfaceContainer: root.solveSurfaceColor(m3colors.m3surfaceContainerLow, m3colors.m3surfaceContainer, 1 - root.contentTransparency)
        property color colSurfaceContainerHigh: root.solveSurfaceColor(m3colors.m3surfaceContainer, m3colors.m3surfaceContainerHigh, 1 - root.contentTransparency)
        property color colSurfaceContainerHighest: root.solveSurfaceColor(m3colors.m3surfaceContainerHigh, m3colors.m3surfaceContainerHighest, 1 - root.contentTransparency)
        property color colSurfaceContainerHighestHover: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3surfaceContainerHighest, m3colors.m3onSurface, 0.95), root.contentTransparency)
        property color colSurfaceContainerHighestActive: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3surfaceContainerHighest, m3colors.m3onSurface, 0.85), root.contentTransparency)
        ...
        property color colErrorContainer: root.transparentSurfaceColor(m3colors.m3errorContainer, root.contentTransparency)
        property color colErrorContainerHover: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3errorContainer, m3colors.m3onErrorContainer, 0.90), root.contentTransparency)
        property color colErrorContainerActive: root.transparentSurfaceColor(ColorUtils.mix(m3colors.m3errorContainer, m3colors.m3onErrorContainer, 0.70), root.contentTransparency)
